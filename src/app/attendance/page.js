  ...
  return (
    <div>
      <div className="flex justify-between mb-4 mx-12">
        <h1></h1>
        <h2 className="text-2xl font-semibold text-center my-4">Attendance Table</h2>
        <button
      ...
      <AttendanceTable attendanceUpdated={attendanceUpdated} refetchAttendance={refetchAttendance} />

      {/* AddDrawer opens a form to submit check-in/check-out */}
      <AddDrawer title="Add Attendance Record" open={open} setOpen={setOpen}>
        <AttendanceForm refetchAttendance={refetchAttendance} setOpen={setOpen} />
      </AddDrawer>
    </div>
  );
}
