...
export async function GET(request) {
    ...
    try {
        ...
        WHERE 
    (e.contract_end_date IS NULL OR e.contract_end_date >= TO_DATE($1 || '-01', 'YYYY-MM-DD'))
    AND e.contract_start_date <= (TO_DATE($1 || '-01', 'YYYY-MM-DD') + INTERVAL '1 month' - INTERVAL '1 day')
